...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    tags: ['Gutenberg', 'Full-Site Editing', 'WordPress Plugin Development', 'REST API'],
    details: [
      'Developed custom Gutenberg blocks for Full-Site Editing (FSE) in WordPress',
      'Enhanced the editing experience with user-friendly interfaces',
      'Optimized blocks for performance and accessibility',
    ],
  },
  {
    ...
    tags: ['API Authentication', 'JSON Decode', 'Auth Keys'],
    details: [
  ...
  },
  {
    ...
    tags: ['WordPress Theme Development', 'Figma', 'eCommerce', 'Responsive Design'],
    details: [
  ...
  },
  {
    ...
    tags: ['OpenMap API', 'MySQL', 'Client Database'],
    details: [
  ...
  },
  {
    ...
    tags: ['DevOps', 'CI/CD', 'Cloud Deployment', 'Docker'],
    details: [
  ...
  },
  {
    ...
    description: 'Set up and managed web hosting for American Libraries Magazine using MediaTemplate, Linux CentOS, and a custom LAMP configuration for WordPress.',
    tags: ['Web Hosting', 'Linux CentOS', 'LAMP Stack', 'Cloudflare'],
    details: [
  ...
  },
  {
    ...
    tags: ['WordPress Theme Development', 'Non-Profit', 'Responsive Design'],
    details: [
      'Designed and developed a custom WordPress theme tailored to the needs of a conservation organization',
      'Created custom templates for events and donation pages',
