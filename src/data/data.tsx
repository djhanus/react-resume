...
export const portfolioItems: PortfolioItem[] = [
  ...
  {
    title: 'Custom Gutenberg Blocks for Full-Site Editing',
    client: 'TechnologyAdvice - Website (2025)',
  ...
  {
    title: 'JSON Validation for WordPress Shortcodes',
    client: 'Tech Republic (2024)',
  ...
  {
    title: 'Custom WordPress Themes from Figma Designs',
    client: 'Brandography - Client Site (2023)',
    description: 'Created custom WordPress themes based on Figma designs for eCommerce and marketing sites, ensuring pixel-perfect implementation and responsiveness.',
    tags: ['WordPress Theme Development', 'Figma', 'eCommerce', 'Marketing Sites', 'Responsive Design'],
    details: [
      'Developed custom WordPress themes from Figma designs',
      'Ensured pixel-perfect implementation and responsiveness across devices',
      'Collaborated with marketing and UX teams to optimize SEO performance',
      'Implemented WCAG compliance for accessibility standards',
      'Optimized themes for performance and user experience, enhancing site speed and usability',
    ],
  },
  {
  ...
  {
    title: 'Custom WordPress Themes from Adobe XD Designs',
    client: 'Brandography - Client Site (2023)',
    description: 'Created custom WordPress themes based on Adobe XD designs for eCommerce and marketing sites, ensuring pixel-perfect implementation and responsiveness.',
    tags: ['WordPress Theme Development', 'Adobe XD', 'eCommerce', 'Marketing Sites', 'Responsive Design'],
    details: [
      'Developed custom WordPress themes from Adobe XD designs',
      'Ensured pixel-perfect implementation and responsiveness across devices',
      'Collaborated with marketing and UX teams to optimize SEO performance',
      'Implemented WCAG compliance for accessibility standards',
      'Optimized themes for performance and user experience, enhancing site speed and usability',
  ...
  {
    title: 'DevOps and CI/CD Pipeline Coordination',
    client: 'Technology Advice - Client Site (2025)',
    description: 'Coordinated the development and deployment of CI/CD pipelines, working closely with sysadmins to ensure smooth operations and efficient workflows.',
    tags: ['DevOps', 'CI/CD', 'Cloud Deployment', 'Docker', 'Kubernetes'],
    details: [
      'Coordinated the development and deployment of CI/CD pipelines',
      'Worked closely with sysadmins to ensure smooth operations and efficient workflows',
      'Managed cloud-based solutions using AWS, Docker, and Kubernetes',
      'Implemented best practices for continuous integration and deployment',
      'Optimized deployment processes to reduce downtime and improve efficiency',
    ],
  },
  {
    title: 'Advanced Web Hosting for American Libraries Magazine',
    client: 'American Libraries Magazine - https://americanlibrariesmagazine.org/ (2023)',
    description: 'Set up and managed web hosting for American Libraries Magazine using MediaTemplate, Linux CentOS, and a custom LAMP configuration for WordPress. Implemented Cloudflare for CDN, firewall support, and traffic management.',
    tags: ['Web Hosting', 'Linux CentOS', 'LAMP Stack', 'WordPress', 'Cloudflare', 'CDN'],
    details: [
      'Set up and managed web hosting for American Libraries Magazine using MediaTemplate',
      'Configured Linux CentOS with a custom LAMP stack for optimal WordPress performance',
      'Implemented Cloudflare for CDN, enhancing site speed and security',
      'Managed firewall support and traffic management to ensure site reliability',
      'Optimized server configurations for performance and scalability',
    ],
  },
  {
    title: 'Custom WordPress Theme for Conservation Organization',
    client: 'Sycamore Land Trust - Client Site (2020)',
    description: 'Developed a custom WordPress theme for a conservation organization, focusing on showcasing their mission, events, and donation opportunities.',
    tags: ['WordPress Theme Development', 'Non-Profit', 'Responsive Design', 'Custom Templates', 'SEO Optimization'],
    details: [
      'Designed and developed a custom WordPress theme tailored to the needs of a conservation organization',
      'Created custom templates for events, donation pages, and volunteer opportunities',
      'Ensured responsive design for optimal user experience across devices',
      'Collaborated with stakeholders to align the website with the organization’s mission and branding',
      'Optimized the site for SEO to increase visibility and engagement',
    ],
  },
];
